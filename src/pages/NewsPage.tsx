...
const DEFAULT_NEWS: NewsItem[] = [
  ...
  { id: '3', title: 'Biển Sầm Sơn đẹp nhất tháng 4 – Mùa du lịch chính thức bắt đầu', excerpt: 'Tháng 4 biển Sầm Sơn trong xanh, sóng êm.', category: 'Biển Sầm Sơn hôm nay', image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&h=400&fit=crop', date: '30/03/2024' },
  { id: '4', title: 'Sầm Sơn mùa biển động – Ngư dân vẫn ra khơi mang về mực tươi', excerpt: 'Dù biển có lúc động, ngư dân Sầm Sơn vẫn kiên cường ra khơi.', category: 'Biển Sầm Sơn hôm nay', image: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=600&h=400&fit=crop', date: '28/03/2024' },
  { id: '5', title: '🔥 Flash Sale tháng 4 – Giảm 15% combo quà biếu cao cấp', excerpt: 'Nhân dịp đầu tháng 4, giảm 15% tất cả combo quà biếu.', category: 'Khuyến mãi', image: 'https://images.unsplash.com/photo-1565680018093-ebb6e46b0bbe?w=600&h=400&fit=crop', date: '01/04/2024', tag: 'HOT' },
  { id: '6', title: 'Mua 2 tặng 1 Nem chua Thanh Hóa – Chỉ trong tuần này', excerpt: 'Đặt từ 2 sản phẩm bất kỳ, tặng ngay 1 gói Nem chua Thanh Hóa.', category: 'Khuyến mãi', image: 'https://images.unsplash.com/photo-1615141982883-c7ad0e69fd62?w=600&h=400&fit=crop', date: '01/04/2024', tag: 'HOT' },
  { id: '7', title: 'Chị Hương (Hà Nội): "Mực ngon nhất từng mua online!"', excerpt: '"Lần đầu đặt thử 1kg mực câu, không ngờ ngon hơn cả mua ngoài chợ."', category: 'Feedback khách', image: 'https://images.unsplash.com/photo-1565680018434-6ce838ebe6f0?w=600&h=400&fit=crop', date: '29/03/2024' },
