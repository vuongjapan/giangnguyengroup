...
import { ArrowLeft, Truck, Package, ShieldCheck, Lock, CreditCard, CheckCircle } from 'lucide-react';
...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Lỗi vận chuyển (hư hỏng, mất hàng)', desc: 'Shop chịu 100% trách nhiệm' },
    ],
  },
  {
    icon: ShieldCheck,
    title: 'Chính sách bảo hành',
    intro: 'GIANG NGUYEN SEAFOOD cam kết: 100% hải sản tự nhiên – Không hóa chất – Đúng nguồn gốc biển Sầm Sơn.',
    items: [
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="container mx-auto px-4 py-8 flex-1 max-w-4xl">
        ...
        <div className="mt-10 ocean-gradient rounded-2xl p-8 text-center">
          ...
          <p className="text-primary-foreground/80 text-sm mb-4">Hotline hỗ trợ: 0123.456.789 • Zalo: 0123.456.789</p>
          <Link to="/"
